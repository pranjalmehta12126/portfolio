        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>3D ART & RENDERING</h3>
              <h4>Cinematic Visuals & Renders</h4>
              <p>
                Creating immersive 3D environments, product visualizations, 
                and cinematic renders using industry-standard tools.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>VIDEO EDITING</h3>
              <h4>Reels & Highlights</h4>
              <p>
                Editing engaging short-form and long-form content with 
                high-quality VFX, compositing, and seamless transitions.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
